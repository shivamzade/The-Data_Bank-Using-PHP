	 ...
	 <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="view_users.php" class="waves-effect">
          <i class="icon-user"></i> <span>Manage Users</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
        
      </li>
      <li>
        <a href="add_items.php" class="waves-effect">
          <i class="icon-plus"></i> <span>Add Items</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
      </li>
      <li>
        <a href="view_all_items.php" class="waves-effect">
          <i class="icon-layers"></i> <span>View Data</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
      ...
      <li>
        <a href="../users/logout.php" class="waves-effect">
    ...
    <li class="nav-item">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        ...
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><i class="icon-power mr-2"></i><a href="../users/logout.php">Logout</a></li>
      </ul>
    </li>
  </ul>
</nav>
