...
$sql = "SELECT `mail_verified_status` FROM `users` WHERE `unique_id` = ? AND `is_del` = 'approved'";
...
$sql = "UPDATE `users` SET `mail_verified_status` = ? WHERE `unique_id` = ? AND `is_del` = 'approved'";
